...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "MARKET_REVIEW_REGION": {
        ...
        "description": "Market region for review: tw (Taiwan), cn (A-shares), hk (Hong Kong), us (US stocks), jp (Japan), kr (Korea), or both (all markets).",
        "category": "system",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
        ...
        "is_editable": True,
        "default_value": "cn",
        "options": ["tw", "cn", "hk", "us", "jp", "kr", "both"],
        "validation": {"allowed_values": ["tw", "cn", "hk", "us", "jp", "kr", "both"], "delimiter": ","},
        "display_order": 48,
        "help_key": "settings.system.market_review",
        "examples": [
            "MARKET_REVIEW_REGION=cn",
