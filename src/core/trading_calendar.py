...
def compute_effective_region(
    ...
    Args:
        config_region: From MARKET_REVIEW_REGION ('tw' | 'cn' | 'hk' | 'us' | 'jp' | 'kr' | 'both' or comma subset)
    ...
    Returns:
        ...
        'tw' | 'cn' | 'hk' | 'us' | 'jp' | 'kr' | 'both': effective subset for today
    """
    markets = ("cn", "tw", "hk", "us", "jp", "kr")
